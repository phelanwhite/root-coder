...
import { getCategoriesApi, getSearchApi } from "@/services/otruyen.api";
...
const CategoryIdPage = () => {
  ...
  const getDataResult = useQuery({
    queryKey: ["category", slug, searchParams.toString()],
    queryFn: async () => {
      return await getCategoriesApi(slug, searchParams.toString());
    },
    enabled: !!slug,
  });
