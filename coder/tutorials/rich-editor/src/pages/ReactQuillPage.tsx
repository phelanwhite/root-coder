import RichEditorReactQuill from "@/components/react-quill";
...
import 'react-quill/dist/quill.bubble.css';
  ...
  const [theme, setTheme] = useState(() => {
    return window.localStorage.getItem("react-quill-theme") || "snow";
  });
  useEffect(() => {
    window.localStorage.setItem("react-quill-theme", theme);
  }, [theme]);
